...
// 1. Handle Public Contact Form Submission (PHP POST)
...
// 4. Handle Admin Actions (Toggle Read / Delete)
...
// 5. Fetch Messages if Admin is Logged In
$messages = [];
$totalCount = 0;
$unreadCount = 0;
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ADMIN DATABASE SECTION - SHARP STYLING */
        .admin-section {
            margin-top: 5rem;
            background: #0A0B0E;
...
<body>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <!-- ADMIN DATABASE MESSAGES INBOX SECTION -->
